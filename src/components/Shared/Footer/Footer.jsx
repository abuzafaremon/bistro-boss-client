...
const Footer = () => {
  return (
    <footer>
      <div className="flex items-center p-10 bg-neutral text-neutral-content">
        <div className="text-center w-full">
          <h2 className="uppercase text-3xl mb-6">Contact Us</h2>
        ...
        <div className="w-full text-center">
          <h2 className="mb-6 text-3xl">Follow Us</h2>
